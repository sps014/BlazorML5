...
public class BoundingBox
    ...
    public class FaceResult
    {
        ...
        public double FaceInViewConfidence { get; set; }
...
public record FaceMeshOptions
{
    public bool FlipHorizontal { get; init; } = false;
    public int MaxContinuousChecks { get; init; } = 5;
    public double DetectionConfidence { get; init; }= 0.9;
    public int MaxFaces { get; init; } = 10; 
    public  double ScoreThreshold { get; init; } =0.75;
    public double IouThreshold { get; init; } = 0.3;
}
